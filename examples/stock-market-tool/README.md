...
# Verify deployment
kubectl get pods -n truvag3-examples -l app=stock-tool
```
...
kubectl port-forward -n truvag3-examples svc/stock-service 8082:80
...
kubectl logs -n truvag3-examples -l app=stock-tool | grep -i "api"
...
2. Check pod environment: `kubectl exec -n truvag3-examples <pod-name> -- env | grep FINNHUB`
3. Restart deployment: `kubectl rollout restart deployment/stock-tool -n truvag3-examples`
...
```bash
# View tool logs
kubectl logs -n truvag3-examples -l app=stock-tool
