...
func (t *TravelChatAgent) handleListSessions(w http.ResponseWriter, r *http.Request) {
	// Handle CORS preflight
	if r.Method == http.MethodOptions {
		setCORSHeaders(w)
		w.WriteHeader(http.StatusOK)
...
func (t *TravelChatAgent) handleUpdateTitle(w http.ResponseWriter, r *http.Request) {
	// Handle CORS preflight
	if r.Method == http.MethodOptions {
		setCORSHeaders(w)
		w.WriteHeader(http.StatusOK)
...
func (t *TravelChatAgent) handleDeleteSession(w http.ResponseWriter, r *http.Request) {
	// Handle CORS preflight
	if r.Method == http.MethodOptions {
		setCORSHeaders(w)
		w.WriteHeader(http.StatusOK)
...
func (t *TravelChatAgent) handleQuery(w http.ResponseWriter, r *http.Request) {
	startTime := time.Now()
	ctx := r.Context()
	...
	telemetry.Counter("chat.requests", "status", "success", "module", "travel-chat-agent")
	telemetry.RecordRequest("travel-chat-agent", "query", durationMs, "success")
